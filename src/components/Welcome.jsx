export default function Welcome({ changeView,setChangeView }) {
    ...
    return (
        <div className='flex flex-col justify-center items-center text-white w-full h-screen px-5 mx-auto 
        md:mt-5 md:mb-10 md:h-96 md:rounded-lg md:items-start md:flex-grow bg-[url("/img/home.png")] bg-center bg-cover'>
