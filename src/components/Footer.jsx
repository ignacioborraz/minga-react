        ...
        <footer className='flex flex-col w-full justify-between items-center pb-5 bg-white'>
            ...
            <div className='flex flex-col items-center px-5 w-full md:w-11/12 md:flex-row md:justify-between '>
                <div className='flex justify-evenly items-center mt-2'>
                    <Anchor to='/' className='mr-10 text-xl' href="">Home</Anchor>
                    <Anchor to='/mangas' className='text-xl' href="">Mangas</Anchor>
                </div>
                ...
                <div className='flex flex-col items-center mt-2'>
                    ...
                    <Anchor to='/donate' className="border-none bg-gradient-to-r from-[#F9A8D4] to-[#F472B6] w-full p-2 justify-center text-xl text-white mt-2 rounded-lg">Donate ❤️</Anchor>
                </div>
            </div>
        </footer>
    )
