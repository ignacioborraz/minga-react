    ...
    return (
        <>
            ...
            <nav className='flex w-full justify-between items-center px-5 h-20 absolute top-0 z-10 md:w-11/12 2xl:w-[1375px]'>
                <svg ref={menuIcon} onClick={()=>setShow(!show)} className="h-14 p-1 text-[#F472B6] hover:text-white bg-white hover:bg-[#F472B6] rounded-lg" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
